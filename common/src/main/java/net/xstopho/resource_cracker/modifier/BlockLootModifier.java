...
public class BlockLootModifier {
    ...
    public static void init(LootTableModifier modifier) {
        modifier.addLoot(ItemRegistry.NUGGET_DIAMOND, 1f, 3f, CrackerConfig.DIAMOND_NUGGET_FROM_DIAMOND_ORE.get().floatValue(),
                Blocks.DIAMOND_ORE.getLootTable().get(), Blocks.DEEPSLATE_DIAMOND_ORE.getLootTable().get());

        modifier.addLoot(ItemRegistry.NUGGET_DIAMOND, 1f, CrackerConfig.DIAMOND_NUGGET_FROM_COAL_ORE.get().floatValue(),
                Blocks.COAL_ORE.getLootTable().get(), Blocks.DEEPSLATE_COAL_ORE.getLootTable().get());

        modifier.addLoot(ItemRegistry.NUGGET_EMERALD, 1f, 4f, CrackerConfig.EMERALD_NUGGET_FROM_ORE.get().floatValue(),
                Blocks.EMERALD_ORE.getLootTable().get(), Blocks.DEEPSLATE_EMERALD_ORE.getLootTable().get());

        modifier.addLoot(ItemRegistry.NUGGET_COPPER, 1f, 6f, CrackerConfig.COPPER_NUGGET_FROM_ORE.get().floatValue(),
