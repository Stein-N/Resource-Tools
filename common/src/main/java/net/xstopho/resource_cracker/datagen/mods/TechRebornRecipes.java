...
public class TechRebornRecipes extends ModRecipes {
    ...
    public static void generate(RecipeOutput output) {
        ...
        defineRecipe("basalt_dust", ModItemTags.fabricTag("basalt"));
        defineRecipe("bauxite_dust", ModItemTags.fabricTag("bauxite_ores"));
        ...
        defineRecipe("calcite_dust", ModItemTags.fabricTag("coral_blocks"));
        ...
        defineRecipe("galena_dust", ModItemTags.fabricTag("galena_ores"));
        ...
        defineRecipe("peridot_dust", ModItemTags.fabricTag("peridot_ores"));
        ...
        defineRecipe("ruby_dust", ModItemTags.fabricTag("ruby_ores"));
        defineRecipe("sapphire_dust", "sapphire_storage_block", 9);
        defineRecipe("sapphire_dust", "sapphire_gem");
        defineRecipe("sapphire_dust", ModItemTags.fabricTag("sapphire_ores"));
        defineRecipe("sodalite_dust", ModItemTags.fabricTag("sodalite_ores"));
        defineRecipe("sphalerite_dust", ModItemTags.fabricTag("sphalerite_ores"));
